...
import { ArrowLeft, BackHand, Check } from "@mui/icons-material";
      ...
      dependent_list.push(
        <div className="DependentListItem">
          ...
          <div className="DeleteDependent">
            <Button color="error" type="button" variant="contained" onClick={() => { deleteDependent(dependentData.string_id) }}>
      ...
      {loadingUpdatePage ? (
        ...
        <div>
          <div className="ProfileUpdateMain">
            ...
            <div className="ProfileUpdateItem">
              <Button size="large" variant="contained" startIcon={<Check />} color="success" onClick={handleSubmit}>Submit</Button>
            </div>
            <div className="ProfileUpdateItem">
              <Button size="large" variant="contained" startIcon={<ArrowLeft />} onClick={() => { navigate('/ProfileHome'); }}>Back</Button>
            </div>
          </div>
        </div>
      )}
